(function ($) {
    ...
    $(".shoppingcart a.icon.delete").bind("click", function (e) {
        e.preventDefault();
        ...
        // If we got here, the clicked button was not created by KO (which should never happen unless we disable KO).
        var $button = $(this);
